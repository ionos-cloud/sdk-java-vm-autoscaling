...
import com.ionoscloud.vmautoscaling.auth.Authentication;
import com.ionoscloud.vmautoscaling.auth.HttpBasicAuth;
import com.ionoscloud.vmautoscaling.auth.HttpBearerAuth;
import com.ionoscloud.vmautoscaling.auth.ApiKeyAuth;
...
public class ApiClient {
    ...
    private String basePath = "https://api.ionos.com/autoscaling";
    ...
    private void init() {
        ...
        setUserAgent("ionos-cloud-sdk-java-vm-autoscaling-ionoscloud/v1.0.0");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://api.ionos.com/autoscaling
